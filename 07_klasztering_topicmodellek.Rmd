...
ggplotly(tokclean_df, height = 1000)
```
...
```{r  zavarossag, eval = TRUE, fig.height = 2, fig.cap="Zavarosság változása a k függvényében", cache=FALSE}
...
ggplotly(toptermsplot9802gibbs)
```
...
ggplotly(toptermsplot0206gibbs)
```
