...
A glimpse függvény segítségével belepillanthatunk a használt corpusba és láthatjuk, hogy az 3 oszlopból áll a dokumentum azonosítójából, amely csak egy sorszám, a dokumentum szövegéből, és a dokumentumhoz tartozó azonosítóból.
...
Adatbázisunk `r nrow(mnb_pr)` megfigyelésből és `r ncol(mnb_pr)` változóból áll. Az egyetlen lényeges dokumentum metaadat itt is a szövegek megjelenési ideje, de a glimpse függvénnyel itt is ellenőrizhetjük hogyan néz ki a corpus felépítése és milyen metaadatokat tartalmaz pontosan.

```{r}
glimpse(mnb_pr)
```

Ez alapján pedig láthatjuk, hogy a corpus a tényleges szövegek mellett tartalmaz még id sorszámot, pontos dátumot és évet is.
